...
alltest10 = who('*_FZ_0_1');              %% change who is varlist according to analyses
alltest01 = who('*_0_1s_all');
...
%% pour analyse ENTIRE SESSION for HABITUATION

plotvar=allanimstest01;   %% change variable 

timex=(1:1:300)
fa=1;
from=30;%/change_time_bin;        %%% tronçon order trans 1 
to=300;%change_time_bin;
...
%% pour analyse ENTIRE SESSION  for TEST

plotvar=allanims;  %% change variable 
...
%% pour analyse around RIPPLE peak (-0.5 +0.5)

clear plotvar timex fa from to h t order ordervalue PeriodSelect

plotvar=onlyAbis;

timex=(0.01:0.01:1)-0.49;         % when ploting from -0.5 to +0.5
fa=1;
from=21;%/change_time_bin;        %%% tronçon order 
to=81;%change_time_bin;            %% from 21-81 = from -0.3 to +0.3
