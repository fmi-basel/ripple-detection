...
%           'm343TEST1.mat','m344TEST1.mat','m345TEST1.mat','m346TEST1.mat','m348TEST1.mat','m349TEST1.mat',...
%           'm350TEST1.mat','m351TEST1.mat','m352TEST1.mat','m353TEST1.mat','m354TEST1.mat','m355TEST1.mat',...
%           'm356TEST1.mat','m357TEST1.mat','m358TEST1.mat','m359TEST1.mat','m360TEST1.mat','m361TEST1.mat',};
...
%           'm344TEST2.mat','m345TEST2.mat','m346TEST2.mat','m348TEST2.mat','m349TEST2.mat','m350TEST2.mat',...
%           'm351TEST2.mat','m352TEST2.mat','m353TEST2.mat','m354TEST2.mat','m355TEST2.mat','m356TEST2.mat',...
%           'm357TEST2.mat','m358TEST2.mat','m359TEST2.mat','m360TEST2.mat','m361TEST2.mat'};

files1 = {'m330TEST1.mat','m332TEST1.mat','m334TEST1.mat','m335TEST1.mat','m337TEST1.mat',...
          'm338TEST1.mat','m342TEST1.mat','m343TEST1.mat','m344TEST1.mat','m345TEST1.mat',...
          'm346TEST1.mat','m347TEST1.mat','m348TEST1.mat','m349TEST1.mat','m350TEST1.mat',...
          'm351TEST1.mat','m352TEST1.mat','m353TEST1.mat','m354TEST1.mat','m356TEST1.mat',...
          'm357TEST1.mat','m359TEST1.mat','m360TEST1.mat','m361TEST1.mat',};
files2 = {'m332TEST2.mat','m334TEST2.mat','m335TEST2.mat','m337TEST2.mat','m338TEST2.mat',...
          'm342TEST2.mat','m343TEST2.mat','m344TEST2.mat','m345TEST2.mat','m346TEST2.mat',...
          'm347TEST2.mat','m348TEST2.mat','m349TEST2.mat','m350TEST2.mat','m351TEST2.mat',...
          'm352TEST2.mat','m353TEST2.mat','m356TEST2.mat','m357TEST2.mat','m359TEST2.mat',...
          'm360TEST2.mat','m361TEST2.mat'};


files={files1,files2}; %files1,files2,files3, files4;
%BcellPL={'pfc_Bcells_t1.mat','pfc_Bcells_t2.mat'};
BcellBL={'bla_Bcells_test1.mat','bla_Bcells_test2.mat'};
...
for g=1:numel(files)
    ...
    genecells={gene_t1, gene_t2};
   
    %%% creates subcategories of neuron type(IN PN) coupled with neuron ID (discri,Bcell etc.), for PL and BLA %%%
    
    BcellPL_gene= intersect(genecells{g},BcellsPL);
    BcellPL_discri= intersect(discricells{g},BcellsPL);
    
    PLPN_Bdiscri= intersect(cPN,BcellPL_discri);
    PLPN_Bgene= intersect(cPN,BcellPL_gene);
    
    PLIN_Bdiscri= intersect(cIN,BcellPL_discri);
    PLIN_Bgene= intersect(cIN,BcellPL_gene);
    
    BcellB_gene= intersect(genecells{g},BcellsBL);
    BcellB_discri= intersect(discricells{g},BcellsBL);
    
    BPN_Bdiscri= intersect(rPN,BcellB_discri);
    BPN_Bgene= intersect(rPN,BcellB_gene);
    
    BIN_Bdiscri= intersect(rIN,BcellB_discri);
    BIN_Bgene= intersect(rIN,BcellB_gene);
    
    N_type= {PLIN_Bdiscri,BIN_Bdiscri};  %% variable where to put the chosen subcategory in the loop
...
[zscored_all_varcr, basal] = zscoreVar(varstring,bstring,mice,N_type);    % go to 'zscoreVar' function and change baseline
