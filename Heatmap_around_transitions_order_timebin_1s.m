...
subplot(1,2,1)
h=imagesc(plotvartrans1(:,order_trans1)');                 
set(h,'XData',timex)
xlim([-30 45])  %[-1.9 2]
caxis([-4 4])
title('transition 1')
subplot(1,2,2)
h=imagesc(plotvartrans2(:,order_trans2)'); 
set(h,'XData',timex)
xlim([-30 45])
caxis([-4 4])    % adapt from z score window
title('transition 2')
colormap parula
colorbar
box off
...
title('transition 1')
subplot(1,2,2)
h=imagesc(plotvartrans2(:,order_trans1)'); 
set(h,'XData',timex)
xlim([-30 45])
caxis([-4 4])    % adapt from z score window
title('transition 2')
...
subplot(1,2,1)
h=imagesc(plotvartrans1(:,order_trans2)');                 
set(h,'XData',timex)
xlim([-30 45])  %[-1.9 2]
caxis([-4 4])
title('transition 1')
